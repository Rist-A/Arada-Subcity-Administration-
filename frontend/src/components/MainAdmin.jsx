...
import { 
  FiMenu, FiX, FiChevronDown, FiChevronUp, FiRefreshCw, 
  FiHome, FiUser, FiUsers, FiSettings, FiFileText, 
  FiPieChart, FiCalendar, FiKey
} from 'react-icons/fi';
import { Dialog, Transition } from '@headlessui/react';
import { Fragment } from 'react';
...
import HallReservation from './HallReservation';

const MainAdmin = () => {
  // State and logic remains here...
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="p-6">
          ...
          {activeSection === 'createAdmin' || activeSection === 'adminList' && (
            <AdminManagement 
              admins={admins}
              newAdmin={newAdmin}
